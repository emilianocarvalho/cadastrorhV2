                ...
                <div class="card">
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-striped table-vcenter">
                      ...
                      <tbody>
                        <tr>
                          <td class="w-1"><span class="avatar" style="background-image: url(./assets/images/faces/male/9.jpg)"></span></td>
                        ...
                        <tr>
                          <td><span class="avatar" style="background-image: url(./assets/images/faces/female/1.jpg)"></span></td>
                        ...
                        <tr>
                          <td><span class="avatar" style="background-image: url(./assets/images/faces/male/4.jpg)"></span></td>
                          <td>Bobby Knight</td>
                        ...
                        <tr>
                          <td><span class="avatar" style="background-image: url(./assets/images/faces/female/11.jpg)"></span></td>
                          <td>Sharon Wells</td>
                          <td>Fixes #625</td>
                    ...
                    <ul class="list-unstyled list-separated">
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(./assets/images/faces/female/12.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(./assets/images/faces/female/21.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(./assets/images/faces/female/29.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(./assets/images/faces/female/2.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(./assets/images/faces/male/34.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(./assets/images/faces/female/11.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
